...
# MAGIC %md
# MAGIC ## Mapping steps ADS_RDS_EVENT_TYPES_CONDITIONS
...
map_id = 'ADS_RDS_EVENT_TYPES_CONDITIONS'
schema_name = 'gap_catalog.ads_owner'
dif_table = 'gap_catalog.ads_etl_owner.DIFF_ADS_RDS_EVENT_TYPES_CONDITIONS_ADS_MAP_SCD_DIFF'
...
# MAGIC %sql truncate table gap_catalog.ads_etl_owner.XC_RDS_EVENT_TYPES_CONDITIONS

# COMMAND ----------

# DBTITLE 1,Fill XC Table
# MAGIC %sql
# MAGIC INSERT INTO gap_catalog.ads_etl_owner.XC_RDS_EVENT_TYPES_CONDITIONS 
# MAGIC       with C_0FILTERAU84TO1142BSSGTJ6I7FB5K9AR as (
# MAGIC       select
# MAGIC           RDS_CONDITIONFULFILLMENTEVENT.id  ID,
# MAGIC           RDS_CONDITIONFULFILLMENTEVENT.value  VALUE
# MAGIC         from gap_catalog.ads_etl_owner.DLK_ADS_LOV_RDS_CONDITIONfulfillmentevent RDS_CONDITIONFULFILLMENTEVENT
# MAGIC         where ( CAST(from_utc_timestamp(SYS_EFFECTIVE_DATE, 'Europe/Prague') AS DATE) = '$p_load_date'
# MAGIC             and RDS_CONDITIONFULFILLMENTEVENT.lang = 'CZ'
# MAGIC             and RDS_CONDITIONFULFILLMENTEVENT.sys = 'Brasil'
# MAGIC               )
# MAGIC       )
# MAGIC       select  /*+no hint*/
# MAGIC               /*seznam vkladanych nebo updatovanych sloupcu bez SK, auditnich atribudu a deleted flagu*/
# MAGIC           FILTER_A.ID EVETP_SOURCE_ID,
# MAGIC           'ADS' EVETP_SOURCE_SYSTEM_ID,
# MAGIC           'RDS_CONDITIONFULFILLMENTEVENT' EVETP_SOURCE_SYS_ORIGIN,
# MAGIC           FILTER_A.VALUE EVETP_DESC,
# MAGIC           FILTER_A.ID EVETP_EVENT_TABLE_NAME,
# MAGIC           'XNA' EVETP_TARGET,
# MAGIC           'XNA' EVETP_DATA_PATH,
# MAGIC           'N' EVETP_DELETED_FLAG
# MAGIC         from (C_0FILTERAU84TO1142BSSGTJ6I7FB5K9AR FILTER_A)
# MAGIC         where (1=1)
# MAGIC ;
...
# MAGIC %sql
# MAGIC DROP TABLE IF EXISTS gap_catalog.ads_etl_owner.DIFF_ADS_RDS_EVENT_TYPES_CONDITIONS_ADS_MAP_SCD_DIFF;

# COMMAND ----------

# DBTITLE 1,Create DIFF Table
# MAGIC %sql
# MAGIC create  table gap_catalog.ads_etl_owner.DIFF_ADS_RDS_EVENT_TYPES_CONDITIONS_ADS_MAP_SCD_DIFF
...
# MAGIC        EVETP_TARGET, 
# MAGIC        EVETP_DATA_PATH
# MAGIC        from gap_catalog.ads_etl_owner.XC_RDS_EVENT_TYPES_CONDITIONS xc
# MAGIC     where (EVETP_SOURCE_SYS_ORIGIN = 'RDS_CONDITIONFULFILLMENTEVENT')) src LEFT JOIN
...
# MAGIC        and (EVETP_SOURCE_SYS_ORIGIN = 'RDS_CONDITIONFULFILLMENTEVENT')      ) trg
...
# MAGIC         and EVETP_VALID_TO  = to_date('01013000','ddMMyyyy')
# MAGIC        and (EVETP_SOURCE_SYS_ORIGIN = 'RDS_CONDITIONFULFILLMENTEVENT')      ) trg LEFT JOIN
# MAGIC     (select /*+ full(xc) */      EVETP_SOURCE_ID, 
# MAGIC        EVETP_SOURCE_SYSTEM_ID, 
# MAGIC        EVETP_SOURCE_SYS_ORIGIN, 
# MAGIC        to_date('30000101','yyyyMMdd') as EVETP_VALID_TO
# MAGIC        from gap_catalog.ads_etl_owner.XC_RDS_EVENT_TYPES_CONDITIONS xc
# MAGIC     where (EVETP_SOURCE_SYS_ORIGIN = 'RDS_CONDITIONFULFILLMENTEVENT')) src
# MAGIC ON trg.EVETP_SOURCE_ID = src.EVETP_SOURCE_ID
# MAGIC  and trg.EVETP_SOURCE_SYSTEM_ID = src.EVETP_SOURCE_SYSTEM_ID
# MAGIC  and trg.EVETP_SOURCE_SYS_ORIGIN = src.EVETP_SOURCE_SYS_ORIGIN
