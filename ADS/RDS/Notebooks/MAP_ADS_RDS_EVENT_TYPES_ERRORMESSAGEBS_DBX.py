...
# MAGIC %md
# MAGIC ## Mapping steps ADS_RDS_EVENT_TYPES_ERRORMESSAGEBS
...
map_id = 'ADS_RDS_EVENT_TYPES_ERRORMESSAGEBS'
schema_name = 'gap_catalog.ads_owner'
dif_table = 'gap_catalog.ads_etl_owner.DIFF_ADS_RDS_EVENT_TYPES_ERRORMESSAGEBS_ADS_MAP_SCD_DIFF'
...
# MAGIC %sql truncate table gap_catalog.ads_etl_owner.XC_RDS_EVENT_TYPES_ERRORMESSAGEBS

# COMMAND ----------

# DBTITLE 1,Fill XC Table
# MAGIC %sql
# MAGIC INSERT INTO gap_catalog.ads_etl_owner.XC_RDS_EVENT_TYPES_ERRORMESSAGEBS 
# MAGIC       with C_0FILTERA3QU0UM637CIDIU474D9CJBI8D as (
# MAGIC       select
# MAGIC           RDS_ERRORMESSAGEBS.id  ID,
# MAGIC           RDS_ERRORMESSAGEBS.value  VALUE
# MAGIC         from gap_catalog.ads_etl_owner.DLK_ADS_LOV_RDS_ERRORMESSAGEBS RDS_ERRORMESSAGEBS
# MAGIC         where ( CAST(from_utc_timestamp(SYS_EFFECTIVE_DATE, 'Europe/Prague') AS DATE) = '$p_load_date'
# MAGIC             and RDS_ERRORMESSAGEBS.lang = 'CZ'
# MAGIC             and RDS_ERRORMESSAGEBS.sys = 'Brasil'
# MAGIC             and RDS_ERRORMESSAGEBS.std_deleted_flag = 'N'
# MAGIC             and RDS_ERRORMESSAGEBS.id like ('SCOPE.%')
# MAGIC               )
# MAGIC       )
# MAGIC       select  /*+no hint*/
# MAGIC               /*seznam vkladanych nebo updatovanych sloupcu bez SK, auditnich atribudu a deleted flagu*/
# MAGIC           REGEXP_REPLACE(FILTER_A.ID, 'SCOPE.', '') as EVETP_SOURCE_ID,
# MAGIC           'RDS' as EVETP_SOURCE_SYSTEM_ID,
# MAGIC           'RDS_ERRORMESSAGEBS' as EVETP_SOURCE_SYS_ORIGIN,
# MAGIC           FILTER_A.VALUE EVETP_DESC,
# MAGIC           'PROCESS_EVENTS' as EVETP_EVENT_TABLE_NAME,
# MAGIC           'N' as EVETP_DELETED_FLAG
# MAGIC         from (C_0FILTERA3QU0UM637CIDIU474D9CJBI8D FILTER_A)
# MAGIC         where (1=1)
# MAGIC ;
...
# MAGIC %sql
# MAGIC DROP TABLE IF EXISTS gap_catalog.ads_etl_owner.DIFF_ADS_RDS_EVENT_TYPES_ERRORMESSAGEBS_ADS_MAP_SCD_DIFF;

# COMMAND ----------

# DBTITLE 1,Create DIFF Table
# MAGIC %sql
# MAGIC create  table gap_catalog.ads_etl_owner.DIFF_ADS_RDS_EVENT_TYPES_ERRORMESSAGEBS_ADS_MAP_SCD_DIFF
...
# MAGIC        from gap_catalog.ads_etl_owner.XC_RDS_EVENT_TYPES_ERRORMESSAGEBS xc
# MAGIC     where (EVETP_SOURCE_SYSTEM_ID = 'RDS' and EVETP_SOURCE_SYS_ORIGIN = 'RDS_ERRORMESSAGEBS')) src LEFT JOIN
...
# MAGIC        and (EVETP_SOURCE_SYSTEM_ID = 'RDS' and EVETP_SOURCE_SYS_ORIGIN = 'RDS_ERRORMESSAGEBS')      ) trg
...
# MAGIC         and EVETP_VALID_TO  = to_date('01013000','ddMMyyyy')
# MAGIC        and (EVETP_SOURCE_SYSTEM_ID = 'RDS' and EVETP_SOURCE_SYS_ORIGIN = 'RDS_ERRORMESSAGEBS')      ) trg LEFT JOIN
# MAGIC     (select /*+ full(xc) */      EVETP_SOURCE_ID, 
# MAGIC        EVETP_SOURCE_SYSTEM_ID, 
# MAGIC        EVETP_SOURCE_SYS_ORIGIN, 
# MAGIC        to_date('30000101','yyyyMMdd') as EVETP_VALID_TO
# MAGIC        from gap_catalog.ads_etl_owner.XC_RDS_EVENT_TYPES_ERRORMESSAGEBS xc
# MAGIC     where (EVETP_SOURCE_SYSTEM_ID = 'RDS' and EVETP_SOURCE_SYS_ORIGIN = 'RDS_ERRORMESSAGEBS')) src
# MAGIC ON trg.EVETP_SOURCE_ID = src.EVETP_SOURCE_ID
# MAGIC  and trg.EVETP_SOURCE_SYSTEM_ID = src.EVETP_SOURCE_SYSTEM_ID
# MAGIC  and trg.EVETP_SOURCE_SYS_ORIGIN = src.EVETP_SOURCE_SYS_ORIGIN
