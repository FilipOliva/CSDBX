...
# MAGIC %md
# MAGIC ## Mapping steps ADS_RDS_EVENT_TYPES_DISPOTRANSACTIONTYPE
...
map_id = 'ADS_RDS_EVENT_TYPES_DISPOTRANSACTIONTYPE'
schema_name = 'gap_catalog.ads_owner'
dif_table = 'gap_catalog.ads_etl_owner.DIFF_ADS_RDS_EVENT_TYPES_DISPOTRANSACTIONTYPE_ADS_MAP_SCD_DIFF'
...
# MAGIC %sql truncate table gap_catalog.ads_etl_owner.XC_RDS_EVENT_TYPES_DISPOTRANSACTIONTYPE

# COMMAND ----------

# DBTITLE 1,Fill XC Table
# MAGIC %sql
# MAGIC INSERT INTO gap_catalog.ads_etl_owner.XC_RDS_EVENT_TYPES_DISPOTRANSACTIONTYPE 
# MAGIC       with C_0FILTERANDRSDV2TNAN0IDC7TCOO729H6 as (
# MAGIC       select
# MAGIC         RDS_DISPOTRANSACTIONTYPE.id  ID,
# MAGIC         RDS_DISPOTRANSACTIONTYPE.value  VALUE
# MAGIC       from
# MAGIC         gap_catalog.ads_etl_owner.DLK_ADS_LOV_RDS_DISPOTRANSACTIONTYPE RDS_DISPOTRANSACTIONTYPE
# MAGIC       where ( CAST(from_utc_timestamp(SYS_EFFECTIVE_DATE, 'Europe/Prague') AS DATE) = '$p_load_date'
# MAGIC           and RDS_DISPOTRANSACTIONTYPE.sys = 'Brasil'
# MAGIC           and RDS_DISPOTRANSACTIONTYPE.lang = 'CZ'
# MAGIC           and RDS_DISPOTRANSACTIONTYPE.std_deleted_flag='N'
# MAGIC             )
# MAGIC       )
...
# MAGIC           'RDS_DISPOTRANSACTIONTYPE' as EVETP_SOURCE_SYS_ORIGIN,
...
# MAGIC         from (C_0FILTERANDRSDV2TNAN0IDC7TCOO729H6 FILTER_A)
# MAGIC         where (1=1)
# MAGIC ;
...
# MAGIC %sql
# MAGIC DROP TABLE IF EXISTS gap_catalog.ads_etl_owner.DIFF_ADS_RDS_EVENT_TYPES_DISPOTRANSACTIONTYPE_ADS_MAP_SCD_DIFF;

# COMMAND ----------

# DBTITLE 1,Create DIFF Table
# MAGIC %sql
# MAGIC create  table gap_catalog.ads_etl_owner.DIFF_ADS_RDS_EVENT_TYPES_DISPOTRANSACTIONTYPE_ADS_MAP_SCD_DIFF
...
# MAGIC        EVETP_TARGET, 
# MAGIC        EVETP_DATA_PATH
# MAGIC        from gap_catalog.ads_etl_owner.XC_RDS_EVENT_TYPES_DISPOTRANSACTIONTYPE xc
# MAGIC     where (EVETP_SOURCE_SYS_ORIGIN='RDS_DISPOTRANSACTIONTYPE')) src LEFT JOIN
...
# MAGIC        and (EVETP_SOURCE_SYS_ORIGIN='RDS_DISPOTRANSACTIONTYPE')      ) trg
...
# MAGIC         and EVETP_VALID_TO  = to_date('01013000','ddMMyyyy')
# MAGIC        and (EVETP_SOURCE_SYS_ORIGIN='RDS_DISPOTRANSACTIONTYPE')      ) trg LEFT JOIN
# MAGIC     (select /*+ full(xc) */      EVETP_SOURCE_ID, 
# MAGIC        EVETP_SOURCE_SYSTEM_ID, 
# MAGIC        EVETP_SOURCE_SYS_ORIGIN, 
# MAGIC        to_date('30000101','yyyyMMdd') as EVETP_VALID_TO
# MAGIC        from gap_catalog.ads_etl_owner.XC_RDS_EVENT_TYPES_DISPOTRANSACTIONTYPE xc
# MAGIC     where (EVETP_SOURCE_SYS_ORIGIN='RDS_DISPOTRANSACTIONTYPE')) src
# MAGIC ON trg.EVETP_SOURCE_ID = src.EVETP_SOURCE_ID
# MAGIC  and trg.EVETP_SOURCE_SYSTEM_ID = src.EVETP_SOURCE_SYSTEM_ID
# MAGIC  and trg.EVETP_SOURCE_SYS_ORIGIN = src.EVETP_SOURCE_SYS_ORIGIN
