...
# MAGIC %md
# MAGIC ## Mapping steps ADS_RDS_EVENT_TYPES_MAIN
# MAGIC - Generated from Oracle Import file using IMPD_Convert_Map_Steps_Ora2DBX.py
# MAGIC - Export date: 2025-09-16 12:41:53
...
map_id = 'ADS_RDS_EVENT_TYPES_MAIN'
schema_name = 'gap_catalog.ads_owner'
dif_table = 'gap_catalog.ads_etl_owner.DIFF_ADS_RDS_EVENT_TYPES_MAIN_ADS_MAP_SCD_DIFF'
...
# MAGIC %sql truncate table gap_catalog.ads_etl_owner.XC_RDS_EVENT_TYPES_MAIN

# COMMAND ----------

# DBTITLE 1,Fill XC Table
# MAGIC %sql
# MAGIC INSERT INTO gap_catalog.ads_etl_owner.XC_RDS_EVENT_TYPES_MAIN 
# MAGIC       with C_0FILTERA5N9CFO3HGCAMJOS6QL7KQ5MRB as (
# MAGIC       select
# MAGIC           RDS_ANALYTICALEVENTTYPES_1.id  ID,
# MAGIC           RDS_ANALYTICALEVENTTYPES_1.eventtablename  EVENTTABLENAME,
# MAGIC           RDS_ANALYTICALEVENTTYPES_1.sourcesystem  SOURCESYSTEM,
# MAGIC           RDS_ANALYTICALEVENTTYPES_1.value  VALUE,
# MAGIC           RDS_ANALYTICALEVENTTYPES_1.data_path  DATA_PATH,
# MAGIC           RDS_ANALYTICALEVENTTYPES_1.target  TARGET
# MAGIC         from gap_catalog.ads_etl_owner.DLK_ADS_LOV_RDS_ANALYTICALEVENTTYPES RDS_ANALYTICALEVENTTYPES_1
# MAGIC         where ( RDS_ANALYTICALEVENTTYPES_1.sys = 'Brasil'
# MAGIC             and RDS_ANALYTICALEVENTTYPES_1.lang  = 'CZ'
...
# MAGIC           nvl(FILTER_A.SOURCESYSTEM,'ADS') as EVETP_SOURCE_SYSTEM_ID,
# MAGIC           'RDS_ANALYTICALEVENTTYPES' as EVETP_SOURCE_SYS_ORIGIN,
# MAGIC           FILTER_A.VALUE as EVETP_DESC,
# MAGIC           FILTER_A.EVENTTABLENAME as EVETP_EVENT_TABLE_NAME,
# MAGIC           nvl(FILTER_A.TARGET,'XNA') as EVETP_TARGET,
# MAGIC           nvl(FILTER_A.DATA_PATH,'XNA') as EVETP_DATA_PATH,
# MAGIC           'N' as EVETP_DELETED_FLAG
# MAGIC         from (C_0FILTERA5N9CFO3HGCAMJOS6QL7KQ5MRB FILTER_A)
# MAGIC         where (1=1)
# MAGIC ;
...
# MAGIC %sql
# MAGIC DROP TABLE IF EXISTS gap_catalog.ads_etl_owner.DIFF_ADS_RDS_EVENT_TYPES_MAIN_ADS_MAP_SCD_DIFF;

# COMMAND ----------

# DBTITLE 1,Create DIFF Table
# MAGIC %sql
# MAGIC create  table gap_catalog.ads_etl_owner.DIFF_ADS_RDS_EVENT_TYPES_MAIN_ADS_MAP_SCD_DIFF
...
# MAGIC        EVETP_TARGET, 
# MAGIC        EVETP_DATA_PATH
# MAGIC        from gap_catalog.ads_etl_owner.XC_RDS_EVENT_TYPES_MAIN xc
# MAGIC     where (EVETP_SOURCE_SYS_ORIGIN='RDS_ANALYTICALEVENTTYPES')) src LEFT JOIN
...
# MAGIC        and (EVETP_SOURCE_SYS_ORIGIN='RDS_ANALYTICALEVENTTYPES')      ) trg
...
# MAGIC         and EVETP_VALID_TO  = to_date('01013000','ddMMyyyy')
# MAGIC        and (EVETP_SOURCE_SYS_ORIGIN='RDS_ANALYTICALEVENTTYPES')      ) trg LEFT JOIN
# MAGIC     (select /*+ full(xc) */      EVETP_SOURCE_ID, 
# MAGIC        EVETP_SOURCE_SYSTEM_ID, 
# MAGIC        EVETP_SOURCE_SYS_ORIGIN, 
# MAGIC        to_date('30000101','yyyyMMdd') as EVETP_VALID_TO
# MAGIC        from gap_catalog.ads_etl_owner.XC_RDS_EVENT_TYPES_MAIN xc
# MAGIC     where (EVETP_SOURCE_SYS_ORIGIN='RDS_ANALYTICALEVENTTYPES')) src
# MAGIC ON trg.EVETP_SOURCE_ID = src.EVETP_SOURCE_ID
# MAGIC  and trg.EVETP_SOURCE_SYSTEM_ID = src.EVETP_SOURCE_SYSTEM_ID
# MAGIC  and trg.EVETP_SOURCE_SYS_ORIGIN = src.EVETP_SOURCE_SYS_ORIGIN
