...
# MAGIC %md
# MAGIC ## Mapping steps ADS_RDS_EVENT_STATUS_ANALYTICAL
...
map_id = 'ADS_RDS_EVENT_STATUS_ANALYTICAL'
schema_name = 'gap_catalog.ads_owner'
dif_table = 'gap_catalog.ads_etl_owner.DIFF_ADS_RDS_EVENT_STATUS_ANALYTICAL_ADS_MAP_SCD_DIFF'
...
# MAGIC %sql truncate table gap_catalog.ads_etl_owner.XC_RDS_EVENT_STATUS_ANALYTICAL

# COMMAND ----------

# MAGIC %sql
# MAGIC       select
# MAGIC           RDS_ANALYTICALEVENTSTATUS.id  ID,
# MAGIC           RDS_ANALYTICALEVENTSTATUS.sourcesystem  SOURCESYSTEM,
# MAGIC           RDS_ANALYTICALEVENTSTATUS.value  VALUE
# MAGIC         from
# MAGIC           gap_catalog.ads_etl_owner.DLK_ADS_LOV_RDS_ANALYTICALEVENTSTATUS RDS_ANALYTICALEVENTSTATUS
# MAGIC         where 1=1 
# MAGIC           
# MAGIC               
...
# MAGIC %sql
# MAGIC INSERT INTO gap_catalog.ads_etl_owner.XC_RDS_EVENT_STATUS_ANALYTICAL 
# MAGIC       with C_0FILTERA9DVNM9QTTBFNJ8C7227CA98VC as ( 
# MAGIC       select
# MAGIC           RDS_ANALYTICALEVENTSTATUS.id  ID,
# MAGIC           RDS_ANALYTICALEVENTSTATUS.sourcesystem  SOURCESYSTEM,
# MAGIC           RDS_ANALYTICALEVENTSTATUS.value  VALUE
...
# MAGIC             and RDS_ANALYTICALEVENTSTATUS.sys = 'Brasil'
# MAGIC             and RDS_ANALYTICALEVENTSTATUS.lang = 'CZ'
# MAGIC               )
# MAGIC       )
# MAGIC       select  /*+no hint*/
# MAGIC               /*seznam vkladanych nebo updatovanych sloupcu bez SK, auditnich atribudu a deleted flagu*/
# MAGIC           FILTER_A.ID as EST_SOURCE_ID,
# MAGIC           FILTER_A.SOURCESYSTEM as EST_SOURCE_SYSTEM_ID,
# MAGIC           'RDS_ANALYTICALEVENTSTATUS' as EST_SOURCE_SYS_ORIGIN,
# MAGIC           FILTER_A.VALUE as EST_DESC,
# MAGIC           'N' as EST_DELETED_FLAG
# MAGIC         from (C_0FILTERA9DVNM9QTTBFNJ8C7227CA98VC FILTER_A)
# MAGIC         where (1=1)
# MAGIC ;
...
# MAGIC %sql
# MAGIC DROP TABLE IF EXISTS gap_catalog.ads_etl_owner.DIFF_ADS_RDS_EVENT_STATUS_ANALYTICAL_ADS_MAP_SCD_DIFF;

# COMMAND ----------

# DBTITLE 1,Create DIFF Table
# MAGIC %sql
# MAGIC create  table gap_catalog.ads_etl_owner.DIFF_ADS_RDS_EVENT_STATUS_ANALYTICAL_ADS_MAP_SCD_DIFF
...
# MAGIC        from gap_catalog.ads_etl_owner.XC_RDS_EVENT_STATUS_ANALYTICAL xc
# MAGIC     where (EST_SOURCE_SYS_ORIGIN = 'RDS_ANALYTICALEVENTSTATUS')) src LEFT JOIN
...
# MAGIC        and (EST_SOURCE_SYS_ORIGIN = 'RDS_ANALYTICALEVENTSTATUS')      ) trg
...
# MAGIC         and EST_VALID_TO  = to_date('01013000','ddMMyyyy')
# MAGIC        and (EST_SOURCE_SYS_ORIGIN = 'RDS_ANALYTICALEVENTSTATUS')      ) trg LEFT JOIN
# MAGIC     (select /*+ full(xc) */      EST_SOURCE_ID, 
# MAGIC        EST_SOURCE_SYSTEM_ID, 
# MAGIC        EST_SOURCE_SYS_ORIGIN, 
# MAGIC        to_date('30000101','yyyyMMdd') as EST_VALID_TO
# MAGIC        from gap_catalog.ads_etl_owner.XC_RDS_EVENT_STATUS_ANALYTICAL xc
# MAGIC     where (EST_SOURCE_SYS_ORIGIN = 'RDS_ANALYTICALEVENTSTATUS')) src
# MAGIC ON trg.EST_SOURCE_ID = src.EST_SOURCE_ID
# MAGIC  and trg.EST_SOURCE_SYSTEM_ID = src.EST_SOURCE_SYSTEM_ID
# MAGIC  and trg.EST_SOURCE_SYS_ORIGIN = src.EST_SOURCE_SYS_ORIGIN
