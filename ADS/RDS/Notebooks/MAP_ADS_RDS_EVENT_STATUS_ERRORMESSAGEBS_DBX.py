...
# MAGIC %md
# MAGIC ## Mapping steps ADS_RDS_EVENT_STATUS_ERRORMESSAGEBS
...
map_id = 'ADS_RDS_EVENT_STATUS_ERRORMESSAGEBS'
schema_name = 'gap_catalog.ads_owner'
dif_table = 'gap_catalog.ads_etl_owner.DIFF_ADS_RDS_EVENT_STATUS_ERRORMESSAGEBS_ADS_MAP_SCD_DIFF'
...
# MAGIC %sql truncate table gap_catalog.ads_etl_owner.XC_RDS_EVENT_STATUS_ERRORMESSAGEBS

# COMMAND ----------

# DBTITLE 1,Fill XC Table
# MAGIC %sql
# MAGIC INSERT INTO gap_catalog.ads_etl_owner.XC_RDS_EVENT_STATUS_ERRORMESSAGEBS 
# MAGIC       with C_0FILTERAQKE22J06RO5313D7KMN0EK5N8 as (
# MAGIC       select
...
# MAGIC               and RDS_ERRORMESSAGEBS.id not like ('SCOPE.%')
# MAGIC                 )
# MAGIC       )
...
# MAGIC           'RDS_ERRORMESSAGEBS' EST_SOURCE_SYS_ORIGIN,
# MAGIC           FILTER_A.VALUE EST_DESC,
# MAGIC           'N' EST_DELETED_FLAG
# MAGIC         from (C_0FILTERAQKE22J06RO5313D7KMN0EK5N8 FILTER_A)
# MAGIC         where (1=1)
# MAGIC ;
...
# MAGIC %sql
# MAGIC DROP TABLE IF EXISTS gap_catalog.ads_etl_owner.DIFF_ADS_RDS_EVENT_STATUS_ERRORMESSAGEBS_ADS_MAP_SCD_DIFF;

# COMMAND ----------

# DBTITLE 1,Create DIFF Table
# MAGIC %sql
# MAGIC create  table gap_catalog.ads_etl_owner.DIFF_ADS_RDS_EVENT_STATUS_ERRORMESSAGEBS_ADS_MAP_SCD_DIFF
...
# MAGIC        from gap_catalog.ads_etl_owner.XC_RDS_EVENT_STATUS_ERRORMESSAGEBS xc
# MAGIC     where (EST_SOURCE_SYSTEM_ID = 'RDS' and EST_SOURCE_SYS_ORIGIN = 'RDS_ERRORMESSAGEBS')) src LEFT JOIN
...
# MAGIC        and (EST_SOURCE_SYSTEM_ID = 'RDS' and EST_SOURCE_SYS_ORIGIN = 'RDS_ERRORMESSAGEBS')      ) trg
...
# MAGIC         and EST_VALID_TO  = to_date('01013000','ddMMyyyy')
# MAGIC        and (EST_SOURCE_SYSTEM_ID = 'RDS' and EST_SOURCE_SYS_ORIGIN = 'RDS_ERRORMESSAGEBS')      ) trg LEFT JOIN
# MAGIC     (select /*+ full(xc) */      EST_SOURCE_ID, 
# MAGIC        EST_SOURCE_SYSTEM_ID, 
# MAGIC        EST_SOURCE_SYS_ORIGIN, 
# MAGIC        to_date('30000101','yyyyMMdd') as EST_VALID_TO
# MAGIC        from gap_catalog.ads_etl_owner.XC_RDS_EVENT_STATUS_ERRORMESSAGEBS xc
# MAGIC     where (EST_SOURCE_SYSTEM_ID = 'RDS' and EST_SOURCE_SYS_ORIGIN = 'RDS_ERRORMESSAGEBS')) src
# MAGIC ON trg.EST_SOURCE_ID = src.EST_SOURCE_ID
# MAGIC  and trg.EST_SOURCE_SYSTEM_ID = src.EST_SOURCE_SYSTEM_ID
# MAGIC  and trg.EST_SOURCE_SYS_ORIGIN = src.EST_SOURCE_SYS_ORIGIN
