...
# MAGIC %md
# MAGIC ## Mapping steps ADS_RDS_EVENT_STATUS_IDENTIF_STATE
...
map_id = 'ADS_RDS_EVENT_STATUS_IDENTIF_STATE'
schema_name = 'gap_catalog.ads_owner'
dif_table = 'gap_catalog.ads_etl_owner.DIFF_ADS_RDS_EVENT_STATUS_IDENTIF_STATE_ADS_MAP_SCD_DIFF'
...
# MAGIC %sql truncate table gap_catalog.ads_etl_owner.XC_RDS_EVENT_STATUS_IDENTIF_STATE

# COMMAND ----------

# DBTITLE 1,Fill XC Table
# MAGIC %sql
# MAGIC INSERT INTO gap_catalog.ads_etl_owner.XC_RDS_EVENT_STATUS_IDENTIF_STATE 
# MAGIC       with C_0FILTERA9EAP0TTH6FOO07D6LLBH6KD2V as (
# MAGIC       select
# MAGIC           RDS_PERSONIDENTIFICATIONSTATE.description  DESCRIPTION,
# MAGIC           RDS_PERSONIDENTIFICATIONSTATE.value  VALUE
# MAGIC         from gap_catalog.ads_etl_owner.DLK_ADS_LOV_RDS_PERSONIDENTIFICATIONSTATE RDS_PERSONIDENTIFICATIONSTATE
# MAGIC         where ( RDS_PERSONIDENTIFICATIONSTATE.sys ='Brasil'
# MAGIC             and RDS_PERSONIDENTIFICATIONSTATE.lang='EN'
...
# MAGIC           FILTER_A.VALUE as EST_SOURCE_ID,
# MAGIC           'RDS' as EST_SOURCE_SYSTEM_ID,
# MAGIC           'RDS_PERSONIDENTIFICATIONSTATE' as EST_SOURCE_SYS_ORIGIN,
# MAGIC           FILTER_A.DESCRIPTION as EST_DESC,
# MAGIC           'N' as EST_DELETED_FLAG
# MAGIC         from (C_0FILTERA9EAP0TTH6FOO07D6LLBH6KD2V FILTER_A)
# MAGIC         where (1=1)
# MAGIC ;
...
# MAGIC %sql
# MAGIC DROP TABLE IF EXISTS gap_catalog.ads_etl_owner.DIFF_ADS_RDS_EVENT_STATUS_IDENTIF_STATE_ADS_MAP_SCD_DIFF;

# COMMAND ----------

# DBTITLE 1,Create DIFF Table
# MAGIC %sql
# MAGIC create  table gap_catalog.ads_etl_owner.DIFF_ADS_RDS_EVENT_STATUS_IDENTIF_STATE_ADS_MAP_SCD_DIFF
...
# MAGIC        from gap_catalog.ads_etl_owner.XC_RDS_EVENT_STATUS_IDENTIF_STATE xc
# MAGIC     where (est_source_sys_origin='RDS_PERSONIDENTIFICATIONSTATE')) src LEFT JOIN
...
# MAGIC        and (est_source_sys_origin='RDS_PERSONIDENTIFICATIONSTATE')      ) trg
...
# MAGIC         and EST_VALID_TO  = to_date('01013000','ddMMyyyy')
# MAGIC        and (est_source_sys_origin='RDS_PERSONIDENTIFICATIONSTATE')      ) trg LEFT JOIN
# MAGIC     (select /*+ full(xc) */      EST_SOURCE_ID, 
# MAGIC        EST_SOURCE_SYSTEM_ID, 
# MAGIC        EST_SOURCE_SYS_ORIGIN, 
# MAGIC        to_date('30000101','yyyyMMdd') as EST_VALID_TO
# MAGIC        from gap_catalog.ads_etl_owner.XC_RDS_EVENT_STATUS_IDENTIF_STATE xc
# MAGIC     where (est_source_sys_origin='RDS_PERSONIDENTIFICATIONSTATE')) src
# MAGIC ON trg.EST_SOURCE_ID = src.EST_SOURCE_ID
# MAGIC  and trg.EST_SOURCE_SYSTEM_ID = src.EST_SOURCE_SYSTEM_ID
# MAGIC  and trg.EST_SOURCE_SYS_ORIGIN = src.EST_SOURCE_SYS_ORIGIN
