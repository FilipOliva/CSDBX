...
# MAGIC %md
# MAGIC ## Mapping steps ADS_RDS_EVENT_STATUS_DISTRAINT_ACT_STATE
...
map_id = 'ADS_RDS_EVENT_STATUS_DISTRAINT_ACT_STATE'
schema_name = 'gap_catalog.ads_owner'
dif_table = 'gap_catalog.ads_etl_owner.DIFF_ADS_RDS_EVENT_STATUS_DISTRAINT_ACT_STATE_ADS_MAP_SCD_DIFF'
...
# MAGIC %sql truncate table gap_catalog.ads_etl_owner.XC_RDS_EVENT_STATUS_DISTRAINT_ACT_STATE

# COMMAND ----------

# MAGIC    %sql
# MAGIC    with C_0FILTERAM284AQB5NOV73U469AQ8O0E0G as (
# MAGIC       select
# MAGIC           RDS_DISTRAINTACTSTATE.id  ID,
# MAGIC           RDS_DISTRAINTACTSTATE.value  VALUE
# MAGIC         from gap_catalog.ads_etl_owner.DLK_ADS_LOV_RDS_DISTRAINTACTSTATE RDS_DISTRAINTACTSTATE
# MAGIC         where ( RDS_DISTRAINTACTSTATE.sys='Brasil'
# MAGIC             and RDS_DISTRAINTACTSTATE.lang='CZ'
...
# MAGIC           'RDS_DISTRAINTACTSTATE' as EST_SOURCE_SYS_ORIGIN,
# MAGIC           FILTER_A.VALUE as EST_DESC,
# MAGIC           'N' as EST_DELETED_FLAG
# MAGIC         from (C_0FILTERAM284AQB5NOV73U469AQ8O0E0G FILTER_A)
# MAGIC         where (1=1)
...
# MAGIC %sql
# MAGIC INSERT INTO gap_catalog.ads_etl_owner.XC_RDS_EVENT_STATUS_DISTRAINT_ACT_STATE 
# MAGIC       with C_0FILTERAM284AQB5NOV73U469AQ8O0E0G as (
# MAGIC       select
# MAGIC           RDS_DISTRAINTACTSTATE.id  ID,
# MAGIC           RDS_DISTRAINTACTSTATE.value  VALUE
...
# MAGIC %sql
# MAGIC DROP TABLE IF EXISTS gap_catalog.ads_etl_owner.DIFF_ADS_RDS_EVENT_STATUS_DISTRAINT_ACT_STATE_ADS_MAP_SCD_DIFF;

# COMMAND ----------

# DBTITLE 1,Create DIFF Table
# MAGIC %sql
# MAGIC create  table gap_catalog.ads_etl_owner.DIFF_ADS_RDS_EVENT_STATUS_DISTRAINT_ACT_STATE_ADS_MAP_SCD_DIFF
...
# MAGIC        from gap_catalog.ads_etl_owner.XC_RDS_EVENT_STATUS_DISTRAINT_ACT_STATE xc
# MAGIC     where (est_source_sys_origin='RDS_DISTRAINTACTSTATE')) src LEFT JOIN
...
# MAGIC        and (est_source_sys_origin='RDS_DISTRAINTACTSTATE')      ) trg
...
# MAGIC         and EST_VALID_TO  = to_date('01013000','ddMMyyyy')
# MAGIC        and (est_source_sys_origin='RDS_DISTRAINTACTSTATE')      ) trg LEFT JOIN
# MAGIC     (select /*+ full(xc) */      EST_SOURCE_ID, 
# MAGIC        EST_SOURCE_SYSTEM_ID, 
# MAGIC        EST_SOURCE_SYS_ORIGIN, 
# MAGIC        to_date('30000101','yyyyMMdd') as EST_VALID_TO
# MAGIC        from gap_catalog.ads_etl_owner.XC_RDS_EVENT_STATUS_DISTRAINT_ACT_STATE xc
# MAGIC     where (est_source_sys_origin='RDS_DISTRAINTACTSTATE')) src
# MAGIC ON trg.EST_SOURCE_ID = src.EST_SOURCE_ID
# MAGIC  and trg.EST_SOURCE_SYSTEM_ID = src.EST_SOURCE_SYSTEM_ID
# MAGIC  and trg.EST_SOURCE_SYS_ORIGIN = src.EST_SOURCE_SYS_ORIGIN
