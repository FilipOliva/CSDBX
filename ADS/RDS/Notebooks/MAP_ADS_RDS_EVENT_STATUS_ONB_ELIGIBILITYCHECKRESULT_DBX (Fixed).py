...
# MAGIC %md
# MAGIC ## Mapping steps ADS_RDS_EVENT_STATUS_ONB_ELIGIBILITYCHECKRESULT
# MAGIC - Generated from Oracle Import file using IMPD_Convert_Map_Steps_Ora2DBX.py
# MAGIC - Export date: 2025-09-16 12:41:51
...
map_id = 'ADS_RDS_EVENT_STATUS_ONB_ELIGIBILITYCHECKRESULT'
schema_name = 'gap_catalog.ads_owner'
dif_table = 'gap_catalog.ads_etl_owner.DIFF_ADS_RDS_EVENT_STATUS_ONB_ELIGIBILITYCHECKRESULT_ADS_MAP_SCD_DIFF'
...
# MAGIC %sql truncate table gap_catalog.ads_etl_owner.XC_RDS_EVENT_STATUS_ONB_ELIGIBILITYCHECKRESULT

# COMMAND ----------

# DBTITLE 1,Fill XC Table
# MAGIC %sql
# MAGIC INSERT INTO gap_catalog.ads_etl_owner.XC_RDS_EVENT_STATUS_ONB_ELIGIBILITYCHECKRESULT 
# MAGIC       SELECT
# MAGIC              EST_SOURCE_ID
...
# MAGIC       FROM (
# MAGIC             SELECT
# MAGIC                 'ELIGIBILITYRESULT.'||gap_catalog.ads_etl_owner.get_std_code_fn(CDM.value) AS EST_SOURCE_ID
# MAGIC                 ,'RDS' AS EST_SOURCE_SYSTEM_ID
# MAGIC                 ,'RDS_ONBOARDINGELIGIBILITYCHECKRESULT' AS EST_SOURCE_SYS_ORIGIN
# MAGIC                 ,TRIM(BRA.value) AS EST_DESC
# MAGIC             FROM gap_catalog.ads_etl_owner.DLK_ADS_RDS_ONBOARDINGELIGIBILITYCHECKRESULT CDM
# MAGIC                 JOIN  gap_catalog.ads_etl_owner.DLK_ADS_RDS_ONBOARDINGELIGIBILITYCHECKRESULT BRA
# MAGIC                     ON  BRA.id = CDM.id
# MAGIC                         AND BRA.std_deleted_flag = 'N'
# MAGIC                         AND CAST(from_utc_timestamp(bra.SYS_EFFECTIVE_DATE, 'Europe/Prague') AS DATE) = '$p_load_date'
# MAGIC                         AND UPPER(TRIM(BRA.sys)) = 'BRASIL'
# MAGIC                         AND UPPER(TRIM(BRA.lang)) = 'CZ'
# MAGIC                         AND to_date('20250914','yyyymmdd') BETWEEN BRA.validfrom AND BRA.validto
# MAGIC             WHERE CDM.std_deleted_flag = 'N'
# MAGIC                 AND CAST(from_utc_timestamp(cdm.SYS_EFFECTIVE_DATE, 'Europe/Prague') AS DATE) = '$p_load_date'
# MAGIC                 AND UPPER(TRIM(CDM.sys)) = 'CDM'
# MAGIC                 AND UPPER(TRIM(CDM.lang)) = 'CZ'
# MAGIC                 AND to_date('20250914','yyyymmdd') BETWEEN CDM.validfrom AND CDM.validto 
# MAGIC       )      
# MAGIC ;
...
# MAGIC %sql
# MAGIC DROP TABLE IF EXISTS gap_catalog.ads_etl_owner.DIFF_ADS_RDS_EVENT_STATUS_ONB_ELIGIBILITYCHECKRESULT_ADS_MAP_SCD_DIFF;

# COMMAND ----------

# DBTITLE 1,Create DIFF Table
# MAGIC %sql
# MAGIC create  table gap_catalog.ads_etl_owner.DIFF_ADS_RDS_EVENT_STATUS_ONB_ELIGIBILITYCHECKRESULT_ADS_MAP_SCD_DIFF
...
# MAGIC        EST_SOURCE_SYS_ORIGIN, 
# MAGIC        EST_DESC
# MAGIC        from gap_catalog.ads_etl_owner.XC_RDS_EVENT_STATUS_ONB_ELIGIBILITYCHECKRESULT xc
# MAGIC     where (EST_SOURCE_SYSTEM_ID = 'RDS' and  EST_SOURCE_SYS_ORIGIN = 'RDS_ONBOARDINGELIGIBILITYCHECKRESULT')) src LEFT JOIN
...
# MAGIC        and (EST_SOURCE_SYSTEM_ID = 'RDS' and  EST_SOURCE_SYS_ORIGIN = 'RDS_ONBOARDINGELIGIBILITYCHECKRESULT')      ) trg
...
# MAGIC      trg.EST_SOURCE_ID is null or 
# MAGIC      trg.EST_DELETED_FLAG = 'Y'
# MAGIC    );
...
# MAGIC         and EST_VALID_TO  = to_date('01013000','ddMMyyyy')
# MAGIC        and (EST_SOURCE_SYSTEM_ID = 'RDS' and  EST_SOURCE_SYS_ORIGIN = 'RDS_ONBOARDINGELIGIBILITYCHECKRESULT')      ) trg LEFT JOIN
# MAGIC     (select /*+ full(xc) */      EST_SOURCE_ID, 
# MAGIC        EST_SOURCE_SYSTEM_ID, 
# MAGIC        EST_SOURCE_SYS_ORIGIN, 
# MAGIC        to_date('30000101','yyyyMMdd') as EST_VALID_TO
# MAGIC        from gap_catalog.ads_etl_owner.XC_RDS_EVENT_STATUS_ONB_ELIGIBILITYCHECKRESULT xc
# MAGIC     where (EST_SOURCE_SYSTEM_ID = 'RDS' and  EST_SOURCE_SYS_ORIGIN = 'RDS_ONBOARDINGELIGIBILITYCHECKRESULT')) src
# MAGIC ON trg.EST_SOURCE_ID = src.EST_SOURCE_ID
# MAGIC  and trg.EST_SOURCE_SYSTEM_ID = src.EST_SOURCE_SYSTEM_ID
# MAGIC  and trg.EST_SOURCE_SYS_ORIGIN = src.EST_SOURCE_SYS_ORIGIN
