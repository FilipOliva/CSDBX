...
# MAGIC %md
# MAGIC ## Mapping steps ADS_RDS_EVENT_TYPES_HYPO
...
map_id = 'ADS_RDS_EVENT_TYPES_HYPO'
schema_name = 'gap_catalog.ads_owner'
dif_table = 'gap_catalog.ads_etl_owner.DIFF_ADS_RDS_EVENT_TYPES_HYPO_ADS_MAP_SCD_DIFF'
...
# MAGIC %sql truncate table gap_catalog.ads_etl_owner.XC_RDS_EVENT_TYPES_HYPO

# COMMAND ----------

# DBTITLE 1,Fill XC Table
# MAGIC %sql
# MAGIC INSERT INTO gap_catalog.ads_etl_owner.XC_RDS_EVENT_TYPES_HYPO 
# MAGIC       with C_0FILTERAC7V8R1M0146KGKC7TC62PDC4O as (
# MAGIC       select
# MAGIC           RDS_HUMANTASKEVENTTYPE.id  ID,
# MAGIC           RDS_HUMANTASKEVENTTYPE.value  VALUE
# MAGIC         from gap_catalog.ads_etl_owner.DLK_ADS_LOV_RDS_HUMANTASKEVENTTYPE RDS_HUMANTASKEVENTTYPE
# MAGIC         where ( CAST(from_utc_timestamp(SYS_EFFECTIVE_DATE, 'Europe/Prague') AS DATE) = '$p_load_date'
# MAGIC             and RDS_HUMANTASKEVENTTYPE.sys = 'Brasil' and  RDS_HUMANTASKEVENTTYPE.lang = 'CZ'
# MAGIC               )
# MAGIC       )
...
# MAGIC           'BRA' as EVETP_SOURCE_SYSTEM_ID,
# MAGIC           FILTER_A.VALUE as EVETP_DESC,
# MAGIC           'PROCESS_EVENTS' as EVETP_EVENT_TABLE_NAME,
# MAGIC           'RDS_HUMANTASKEVENTTYPE' as EVETP_SOURCE_SYS_ORIGIN,
# MAGIC           'N' as EVETP_DELETED_FLAG
# MAGIC         from (C_0FILTERAC7V8R1M0146KGKC7TC62PDC4O FILTER_A)
# MAGIC         where (1=1)
# MAGIC ;
...
# MAGIC %sql
# MAGIC DROP TABLE IF EXISTS gap_catalog.ads_etl_owner.DIFF_ADS_RDS_EVENT_TYPES_HYPO_ADS_MAP_SCD_DIFF;

# COMMAND ----------

# DBTITLE 1,Create DIFF Table
# MAGIC %sql
# MAGIC create  table gap_catalog.ads_etl_owner.DIFF_ADS_RDS_EVENT_TYPES_HYPO_ADS_MAP_SCD_DIFF
...
# MAGIC        from gap_catalog.ads_etl_owner.XC_RDS_EVENT_TYPES_HYPO xc
# MAGIC     where (EVETP_SOURCE_SYS_ORIGIN='RDS_HUMANTASKEVENTTYPE')) src LEFT JOIN
...
# MAGIC        and (EVETP_SOURCE_SYS_ORIGIN='RDS_HUMANTASKEVENTTYPE')      ) trg
...
# MAGIC      decode( src.EVETP_SOURCE_SYS_ORIGIN,trg.EVETP_SOURCE_SYS_ORIGIN,1,0 ) = 0  or
...
# MAGIC         and EVETP_VALID_TO  = to_date('01013000','ddMMyyyy')
# MAGIC        and (EVETP_SOURCE_SYS_ORIGIN='RDS_HUMANTASKEVENTTYPE')      ) trg LEFT JOIN
# MAGIC     (select /*+ full(xc) */      EVETP_SOURCE_ID, 
# MAGIC        EVETP_SOURCE_SYSTEM_ID, 
# MAGIC        to_date('30000101','yyyyMMdd') as EVETP_VALID_TO
# MAGIC        from gap_catalog.ads_etl_owner.XC_RDS_EVENT_TYPES_HYPO xc
# MAGIC     where (EVETP_SOURCE_SYS_ORIGIN='RDS_HUMANTASKEVENTTYPE')) src
# MAGIC ON trg.EVETP_SOURCE_ID = src.EVETP_SOURCE_ID
# MAGIC  and trg.EVETP_SOURCE_SYSTEM_ID = src.EVETP_SOURCE_SYSTEM_ID
