...
# MAGIC %md
# MAGIC ## Mapping steps ADS_RDS_EVENT_TYPES_DISTRAINT_EVENT_TYPE
...
map_id = 'ADS_RDS_EVENT_TYPES_DISTRAINT_EVENT_TYPE'
schema_name = 'gap_catalog.ads_owner'
dif_table = 'gap_catalog.ads_etl_owner.DIFF_ADS_RDS_EVENT_TYPES_DISTRAINT_EVENT_TYPE_ADS_MAP_SCD_DIFF'
...
# MAGIC %sql truncate table gap_catalog.ads_etl_owner.XC_RDS_EVENT_TYPES_DISTRAINT_EVENT_TYPE

# COMMAND ----------

# DBTITLE 1,Fill XC Table
# MAGIC %sql
# MAGIC INSERT INTO gap_catalog.ads_etl_owner.XC_RDS_EVENT_TYPES_DISTRAINT_EVENT_TYPE 
# MAGIC       with C_0FILTERA8JBGVQUMI765JTI6OQFOK8BR7 as (
# MAGIC       select
# MAGIC           RDS_DISTRAINTEVENTTYPE.id  ID,
# MAGIC           RDS_DISTRAINTEVENTTYPE.value  VALUE
# MAGIC         from gap_catalog.ads_etl_owner.DLK_ADS_LOV_RDS_DISTRAINTEVENTTYPE RDS_DISTRAINTEVENTTYPE
# MAGIC         where ( RDS_DISTRAINTEVENTTYPE.sys  = 'Brasil'
# MAGIC             and RDS_DISTRAINTEVENTTYPE.lang  = 'CZ'
...
# MAGIC           'RDS_DISTRAINTEVENTTYPE' as EVETP_SOURCE_SYS_ORIGIN,
...
# MAGIC         from (C_0FILTERA8JBGVQUMI765JTI6OQFOK8BR7 FILTER_A)
# MAGIC         where (1=1)
# MAGIC ;
...
# MAGIC %sql
# MAGIC DROP TABLE IF EXISTS gap_catalog.ads_etl_owner.DIFF_ADS_RDS_EVENT_TYPES_DISTRAINT_EVENT_TYPE_ADS_MAP_SCD_DIFF;

# COMMAND ----------

# DBTITLE 1,Create DIFF Table
# MAGIC %sql
# MAGIC create  table gap_catalog.ads_etl_owner.DIFF_ADS_RDS_EVENT_TYPES_DISTRAINT_EVENT_TYPE_ADS_MAP_SCD_DIFF
...
# MAGIC        EVETP_TARGET, 
# MAGIC        EVETP_DATA_PATH
# MAGIC        from gap_catalog.ads_etl_owner.XC_RDS_EVENT_TYPES_DISTRAINT_EVENT_TYPE xc
# MAGIC     where (EVETP_SOURCE_SYS_ORIGIN='RDS_DISTRAINTEVENTTYPE')) src LEFT JOIN
...
# MAGIC        and (EVETP_SOURCE_SYS_ORIGIN='RDS_DISTRAINTEVENTTYPE')      ) trg
...
# MAGIC         and EVETP_VALID_TO  = to_date('01013000','ddMMyyyy')
# MAGIC        and (EVETP_SOURCE_SYS_ORIGIN='RDS_DISTRAINTEVENTTYPE')      ) trg LEFT JOIN
# MAGIC     (select /*+ full(xc) */      EVETP_SOURCE_ID, 
# MAGIC        EVETP_SOURCE_SYSTEM_ID, 
# MAGIC        EVETP_SOURCE_SYS_ORIGIN, 
# MAGIC        to_date('30000101','yyyyMMdd') as EVETP_VALID_TO
# MAGIC        from gap_catalog.ads_etl_owner.XC_RDS_EVENT_TYPES_DISTRAINT_EVENT_TYPE xc
# MAGIC     where (EVETP_SOURCE_SYS_ORIGIN='RDS_DISTRAINTEVENTTYPE')) src
# MAGIC ON trg.EVETP_SOURCE_ID = src.EVETP_SOURCE_ID
# MAGIC  and trg.EVETP_SOURCE_SYSTEM_ID = src.EVETP_SOURCE_SYSTEM_ID
# MAGIC  and trg.EVETP_SOURCE_SYS_ORIGIN = src.EVETP_SOURCE_SYS_ORIGIN
