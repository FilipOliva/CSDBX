...
# MAGIC %md
# MAGIC ## Mapping steps ADS_RDS_EVENT_TYPES_DISTRAINT_ACT_TYPE
...
map_id = 'ADS_RDS_EVENT_TYPES_DISTRAINT_ACT_TYPE'
schema_name = 'gap_catalog.ads_owner'
dif_table = 'gap_catalog.ads_etl_owner.DIFF_ADS_RDS_EVENT_TYPES_DISTRAINT_ACT_TYPE_ADS_MAP_SCD_DIFF'
...
# MAGIC %sql truncate table gap_catalog.ads_etl_owner.XC_RDS_EVENT_TYPES_DISTRAINT_ACT_TYPE

# COMMAND ----------

# DBTITLE 1,Fill XC Table
# MAGIC %sql
# MAGIC INSERT INTO gap_catalog.ads_etl_owner.XC_RDS_EVENT_TYPES_DISTRAINT_ACT_TYPE 
# MAGIC       with C_0FILTERAPCR90T2QK5RH0TV7AJMCF7461 as (
# MAGIC       select
# MAGIC           RDS_DISTRAINTACTTYPE.id  ID,
# MAGIC           RDS_DISTRAINTACTTYPE.value  VALUE
# MAGIC         from
# MAGIC           gap_catalog.ads_etl_owner.DLK_ADS_LOV_RDS_DISTRAINTACTTYPE RDS_DISTRAINTACTTYPE
# MAGIC         where ( RDS_DISTRAINTACTTYPE.sys  = 'Brasil'
# MAGIC             and RDS_DISTRAINTACTTYPE.lang  = 'CZ'
...
# MAGIC           'RDS_DISTRAINTACTTYPE' as EVETP_SOURCE_SYS_ORIGIN,
...
# MAGIC         from (C_0FILTERAPCR90T2QK5RH0TV7AJMCF7461 FILTER_A)
# MAGIC         where (1=1)
# MAGIC ;
...
# MAGIC %sql
# MAGIC DROP TABLE IF EXISTS gap_catalog.ads_etl_owner.DIFF_ADS_RDS_EVENT_TYPES_DISTRAINT_ACT_TYPE_ADS_MAP_SCD_DIFF;

# COMMAND ----------

# DBTITLE 1,Create DIFF Table
# MAGIC %sql
# MAGIC create  table gap_catalog.ads_etl_owner.DIFF_ADS_RDS_EVENT_TYPES_DISTRAINT_ACT_TYPE_ADS_MAP_SCD_DIFF
...
# MAGIC        EVETP_TARGET, 
# MAGIC        EVETP_DATA_PATH
# MAGIC        from gap_catalog.ads_etl_owner.XC_RDS_EVENT_TYPES_DISTRAINT_ACT_TYPE xc
# MAGIC     where (EVETP_SOURCE_SYS_ORIGIN='RDS_DISTRAINTACTTYPE')) src LEFT JOIN
...
# MAGIC        and (EVETP_SOURCE_SYS_ORIGIN='RDS_DISTRAINTACTTYPE')      ) trg
...
# MAGIC         and EVETP_VALID_TO  = to_date('01013000','ddMMyyyy')
# MAGIC        and (EVETP_SOURCE_SYS_ORIGIN='RDS_DISTRAINTACTTYPE')      ) trg LEFT JOIN
# MAGIC     (select /*+ full(xc) */      EVETP_SOURCE_ID, 
# MAGIC        EVETP_SOURCE_SYSTEM_ID, 
# MAGIC        EVETP_SOURCE_SYS_ORIGIN, 
# MAGIC        to_date('30000101','yyyyMMdd') as EVETP_VALID_TO
# MAGIC        from gap_catalog.ads_etl_owner.XC_RDS_EVENT_TYPES_DISTRAINT_ACT_TYPE xc
# MAGIC     where (EVETP_SOURCE_SYS_ORIGIN='RDS_DISTRAINTACTTYPE')) src
# MAGIC ON trg.EVETP_SOURCE_ID = src.EVETP_SOURCE_ID
# MAGIC  and trg.EVETP_SOURCE_SYSTEM_ID = src.EVETP_SOURCE_SYSTEM_ID
# MAGIC  and trg.EVETP_SOURCE_SYS_ORIGIN = src.EVETP_SOURCE_SYS_ORIGIN
