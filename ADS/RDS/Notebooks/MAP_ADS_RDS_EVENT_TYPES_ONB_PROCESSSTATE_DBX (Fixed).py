...
# MAGIC %md
# MAGIC ## Mapping steps ADS_RDS_EVENT_TYPES_ONB_PROCESSSTATE
...
map_id = 'ADS_RDS_EVENT_TYPES_ONB_PROCESSSTATE'
schema_name = 'gap_catalog.ads_owner'
dif_table = 'gap_catalog.ads_etl_owner.DIFF_ADS_RDS_EVENT_TYPES_ONB_PROCESSSTATE_ADS_MAP_SCD_DIFF'
...
# MAGIC %sql truncate table gap_catalog.ads_etl_owner.XC_RDS_EVENT_TYPES_ONB_PROCESSSTATE

# COMMAND ----------

# DBTITLE 1,Fill XC Table
# MAGIC %sql
# MAGIC INSERT INTO gap_catalog.ads_etl_owner.XC_RDS_EVENT_TYPES_ONB_PROCESSSTATE 
# MAGIC       SELECT
# MAGIC            gap_catalog.ads_etl_owner.get_std_code_fn(CDM.value) AS EVETP_SOURCE_ID
# MAGIC           ,'RDS' AS EVETP_SOURCE_SYSTEM_ID
# MAGIC           ,'RDS_ONBOARDINGPROCESSSTATE' AS EVETP_SOURCE_SYS_ORIGIN
# MAGIC           ,TRIM(BRA.value) AS EVETP_DESC
# MAGIC           ,'PROCESS_EVENTS' AS EVETP_EVENT_TABLE_NAME
# MAGIC       FROM gap_catalog.ads_etl_owner.DLK_ADS_RDS_ONBOARDINGPROCESSSTATE CDM
# MAGIC           JOIN  gap_catalog.ads_etl_owner.DLK_ADS_RDS_ONBOARDINGPROCESSSTATE BRA
...
# MAGIC %sql
# MAGIC DROP TABLE IF EXISTS gap_catalog.ads_etl_owner.DIFF_ADS_RDS_EVENT_TYPES_ONB_PROCESSSTATE_ADS_MAP_SCD_DIFF;

# COMMAND ----------

# DBTITLE 1,Create DIFF Table
# MAGIC %sql
# MAGIC create  table gap_catalog.ads_etl_owner.DIFF_ADS_RDS_EVENT_TYPES_ONB_PROCESSSTATE_ADS_MAP_SCD_DIFF
...
# MAGIC        EVETP_DESC, 
# MAGIC        EVETP_EVENT_TABLE_NAME
# MAGIC        from gap_catalog.ads_etl_owner.XC_RDS_EVENT_TYPES_ONB_PROCESSSTATE xc
# MAGIC     where (EVETP_SOURCE_SYSTEM_ID = 'RDS'
# MAGIC          and EVETP_SOURCE_SYS_ORIGIN = 'RDS_ONBOARDINGPROCESSSTATE')) src LEFT JOIN
...
# MAGIC        and (EVETP_SOURCE_SYSTEM_ID = 'RDS'
# MAGIC          and EVETP_SOURCE_SYS_ORIGIN = 'RDS_ONBOARDINGPROCESSSTATE')      ) trg
...
# MAGIC      trg.EVETP_SOURCE_ID is null or 
# MAGIC      trg.EVETP_DELETED_FLAG = 'Y'
# MAGIC    );
...
# MAGIC         and EVETP_VALID_TO  = to_date('01013000','ddMMyyyy')
# MAGIC        and (EVETP_SOURCE_SYSTEM_ID = 'RDS'
# MAGIC          and EVETP_SOURCE_SYS_ORIGIN = 'RDS_ONBOARDINGPROCESSSTATE')      ) trg LEFT JOIN
# MAGIC     (select /*+ full(xc) */      EVETP_SOURCE_ID, 
# MAGIC        EVETP_SOURCE_SYSTEM_ID, 
# MAGIC        EVETP_SOURCE_SYS_ORIGIN, 
...
# MAGIC        from gap_catalog.ads_etl_owner.XC_RDS_EVENT_TYPES_ONB_PROCESSSTATE xc
# MAGIC     where (EVETP_SOURCE_SYSTEM_ID = 'RDS'
# MAGIC          and EVETP_SOURCE_SYS_ORIGIN = 'RDS_ONBOARDINGPROCESSSTATE')) src
# MAGIC ON trg.EVETP_SOURCE_ID = src.EVETP_SOURCE_ID
# MAGIC  and trg.EVETP_SOURCE_SYSTEM_ID = src.EVETP_SOURCE_SYSTEM_ID
# MAGIC  and trg.EVETP_SOURCE_SYS_ORIGIN = src.EVETP_SOURCE_SYS_ORIGIN
