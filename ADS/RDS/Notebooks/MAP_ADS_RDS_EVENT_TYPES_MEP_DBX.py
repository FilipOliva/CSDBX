...
# MAGIC %md
# MAGIC ## Mapping steps ADS_RDS_EVENT_TYPES_MEP
...
map_id = 'ADS_RDS_EVENT_TYPES_MEP'
schema_name = 'gap_catalog.ads_owner'
dif_table = 'gap_catalog.ads_etl_owner.DIFF_ADS_RDS_EVENT_TYPES_MEP_ADS_MAP_SCD_DIFF'
...
# MAGIC %sql truncate table gap_catalog.ads_etl_owner.XC_RDS_EVENT_TYPES_MEP
...
# MAGIC       select
# MAGIC           RDS_MEPOPERATIONTYPE.id  ID,
# MAGIC           RDS_MEPOPERATIONTYPE.value  VALUE
# MAGIC         from
# MAGIC           gap_catalog.ads_etl_owner.DLK_ADS_LOV_RDS_MEPOPERATIONTYPE RDS_MEPOPERATIONTYPE
...
# MAGIC %sql
# MAGIC DROP TABLE IF EXISTS gap_catalog.ads_etl_owner.DIFF_ADS_RDS_EVENT_TYPES_MEP_ADS_MAP_SCD_DIFF;

# COMMAND ----------

# DBTITLE 1,Create DIFF Table
# MAGIC %sql
# MAGIC create  table gap_catalog.ads_etl_owner.DIFF_ADS_RDS_EVENT_TYPES_MEP_ADS_MAP_SCD_DIFF
...
# MAGIC     where (EVETP_SOURCE_SYS_ORIGIN='RDS_MEPOPERATIONTYPE')) src LEFT JOIN
...
# MAGIC        and (EVETP_SOURCE_SYS_ORIGIN='RDS_MEPOPERATIONTYPE')      ) trg
...
# MAGIC         and EVETP_VALID_TO  = to_date('01013000','ddMMyyyy')
# MAGIC        and (EVETP_SOURCE_SYS_ORIGIN='RDS_MEPOPERATIONTYPE')      ) trg LEFT JOIN
# MAGIC     (select /*+ full(xc) */      EVETP_SOURCE_ID, 
# MAGIC        EVETP_SOURCE_SYSTEM_ID, 
# MAGIC        EVETP_SOURCE_SYS_ORIGIN, 
# MAGIC        to_date('30000101','yyyyMMdd') as EVETP_VALID_TO
# MAGIC        from gap_catalog.ads_etl_owner.XC_RDS_EVENT_TYPES_MEP xc
# MAGIC     where (EVETP_SOURCE_SYS_ORIGIN='RDS_MEPOPERATIONTYPE')) src
# MAGIC ON trg.EVETP_SOURCE_ID = src.EVETP_SOURCE_ID
# MAGIC  and trg.EVETP_SOURCE_SYSTEM_ID = src.EVETP_SOURCE_SYSTEM_ID
# MAGIC  and trg.EVETP_SOURCE_SYS_ORIGIN = src.EVETP_SOURCE_SYS_ORIGIN
