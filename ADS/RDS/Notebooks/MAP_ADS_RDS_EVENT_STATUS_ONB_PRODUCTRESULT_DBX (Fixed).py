...
# MAGIC %md
# MAGIC ## Mapping steps ADS_RDS_EVENT_STATUS_ONB_PRODUCTRESULT
...
map_id = 'ADS_RDS_EVENT_STATUS_ONB_PRODUCTRESULT'
schema_name = 'gap_catalog.ads_owner'
dif_table = 'gap_catalog.ads_etl_owner.DIFF_ADS_RDS_EVENT_STATUS_ONB_PRODUCTRESULT_ADS_MAP_SCD_DIFF'
...
# MAGIC %sql truncate table gap_catalog.ads_etl_owner.XC_RDS_EVENT_STATUS_ONB_PRODUCTRESULT

# COMMAND ----------

# DBTITLE 1,Fill XC Table
# MAGIC %sql
# MAGIC INSERT INTO gap_catalog.ads_etl_owner.XC_RDS_EVENT_STATUS_ONB_PRODUCTRESULT 
# MAGIC       SELECT
# MAGIC              EST_SOURCE_ID
...
# MAGIC       FROM (
# MAGIC             SELECT
# MAGIC                 'PRODUCTRESULT.'||gap_catalog.ads_etl_owner.get_std_code_fn(CDM.value) AS EST_SOURCE_ID
# MAGIC                 ,'RDS' AS EST_SOURCE_SYSTEM_ID
# MAGIC                 ,'RDS_ONBOARDINGPRODUCTRESULT' AS EST_SOURCE_SYS_ORIGIN
# MAGIC                 ,TRIM(BRA.value) AS EST_DESC
# MAGIC             FROM gap_catalog.ads_etl_owner.DLK_ADS_RDS_ONBOARDINGPRODUCTRESULT CDM
# MAGIC                 JOIN  gap_catalog.ads_etl_owner.DLK_ADS_RDS_ONBOARDINGPRODUCTRESULT BRA
...
# MAGIC %sql
# MAGIC DROP TABLE IF EXISTS gap_catalog.ads_etl_owner.DIFF_ADS_RDS_EVENT_STATUS_ONB_PRODUCTRESULT_ADS_MAP_SCD_DIFF;

# COMMAND ----------

# DBTITLE 1,Create DIFF Table
# MAGIC %sql
# MAGIC create  table gap_catalog.ads_etl_owner.DIFF_ADS_RDS_EVENT_STATUS_ONB_PRODUCTRESULT_ADS_MAP_SCD_DIFF
...
# MAGIC        EST_SOURCE_SYS_ORIGIN, 
# MAGIC        EST_DESC
# MAGIC        from gap_catalog.ads_etl_owner.XC_RDS_EVENT_STATUS_ONB_PRODUCTRESULT xc
# MAGIC     where (EST_SOURCE_SYSTEM_ID = 'RDS' and  EST_SOURCE_SYS_ORIGIN = 'RDS_ONBOARDINGPRODUCTRESULT')) src LEFT JOIN
...
# MAGIC        and (EST_SOURCE_SYSTEM_ID = 'RDS' and  EST_SOURCE_SYS_ORIGIN = 'RDS_ONBOARDINGPRODUCTRESULT')      ) trg
...
# MAGIC         and EST_VALID_TO  = to_date('01013000','ddMMyyyy')
# MAGIC        and (EST_SOURCE_SYSTEM_ID = 'RDS' and  EST_SOURCE_SYS_ORIGIN = 'RDS_ONBOARDINGPRODUCTRESULT')      ) trg LEFT JOIN
# MAGIC     (select /*+ full(xc) */      EST_SOURCE_ID, 
# MAGIC        EST_SOURCE_SYSTEM_ID, 
# MAGIC        EST_SOURCE_SYS_ORIGIN, 
# MAGIC        to_date('30000101','yyyyMMdd') as EST_VALID_TO
# MAGIC        from gap_catalog.ads_etl_owner.XC_RDS_EVENT_STATUS_ONB_PRODUCTRESULT xc
# MAGIC     where (EST_SOURCE_SYSTEM_ID = 'RDS' and  EST_SOURCE_SYS_ORIGIN = 'RDS_ONBOARDINGPRODUCTRESULT')) src
# MAGIC ON trg.EST_SOURCE_ID = src.EST_SOURCE_ID
# MAGIC  and trg.EST_SOURCE_SYSTEM_ID = src.EST_SOURCE_SYSTEM_ID
# MAGIC  and trg.EST_SOURCE_SYS_ORIGIN = src.EST_SOURCE_SYS_ORIGIN
