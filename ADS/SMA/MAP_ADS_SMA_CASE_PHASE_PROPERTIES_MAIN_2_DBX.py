...
# MAGIC %md
# MAGIC ## Mapping steps ADS_SMA_CASE_PHASE_PROPERTIES_MAIN_2
...
map_id = 'ADS_SMA_CASE_PHASE_PROPERTIES_MAIN_2'
schema_name = 'gap_catalog.ads_owner'
dif_table = 'gap_catalog.ads_owner.DIFF_ADS_SMA_CASE_PHASE_PROPERTIES_MAIN_2_ADS_MAP_SCD_DIFF'
...
# MAGIC %sql truncate table gap_catalog.ads_etl_owner.XC_SMA_CASE_PHASE_PROPERTIES_MAIN_2

# COMMAND ----------

# DBTITLE 1,Fill XC Table
# MAGIC %sql
# MAGIC INSERT INTO gap_catalog.ads_etl_owner.XC_SMA_CASE_PHASE_PROPERTIES_MAIN_2 
...
# MAGIC %sql
# MAGIC DROP TABLE IF EXISTS gap_catalog.ads_owner.DIFF_ADS_SMA_CASE_PHASE_PROPERTIES_MAIN_2_ADS_MAP_SCD_DIFF;

# COMMAND ----------

# DBTITLE 1,Create DIFF Table
# MAGIC %sql
# MAGIC create  table gap_catalog.ads_owner.DIFF_ADS_SMA_CASE_PHASE_PROPERTIES_MAIN_2_ADS_MAP_SCD_DIFF
...
# MAGIC        CPPROP_VALUE_NUMBER, 
# MAGIC        CPPRV_KEY
# MAGIC        from gap_catalog.ads_etl_owner.XC_SMA_CASE_PHASE_PROPERTIES_MAIN_2 xc
# MAGIC     where (CPPROP_SOURCE_SYSTEM_ID = 'SMA'
# MAGIC             AND CPPROP_SOURCE_SYS_ORIGIN = 'SMA_MONITOR_EVENTS'
# MAGIC             AND CTP_KEY IN ( 7312,7322,11502,52492,152,172,192,8402,10002,13102,4802,2042,4202,4402,4702,13582,18152,492,22,9632,9102,10902,12102,18252,12712,13902,14102,1292,18282,52682,1262,1282,1312,1462,1422,1252,752,1042,1442,1082,1502,1452,1482,1492,6702,15852,1092,892,9482,2392,2602,3002,2902,3202,3402,3702,3802,17452,14502,862,3602,9752,9592,52,81992,79522,77722,81962,83452,84732,86722,86742,88612,81732,76702,86332,86842,80422,87162,90182,85642,92792,87462,2502,78722,92052,87132,12,91682,80502,92062,83322,93092 ))) src LEFT JOIN
...
# MAGIC             AND CPPROP_SOURCE_SYS_ORIGIN = 'SMA_MONITOR_EVENTS'
# MAGIC             AND CTP_KEY IN ( 7312,7322,11502,52492,152,172,192,8402,10002,13102,4802,2042,4202,4402,4702,13582,18152,492,22,9632,9102,10902,12102,18252,12712,13902,14102,1292,18282,52682,1262,1282,1312,1462,1422,1252,752,1042,1442,1082,1502,1452,1482,1492,6702,15852,1092,892,9482,2392,2602,3002,2902,3202,3402,3702,3802,17452,14502,862,3602,9752,9592,52,81992,79522,77722,81962,83452,84732,86722,86742,88612,81732,76702,86332,86842,80422,87162,90182,85642,92792,87462,2502,78722,92052,87132,12,91682,80502,92062,83322,93092 ))      ) trg
...
# MAGIC union all
# MAGIC select '2-XC_SMA_CASE_PHASE_PROPERTIES_MAIN_2', count(1) from gap_catalog.ads_etl_owner.XC_SMA_CASE_PHASE_PROPERTIES_MAIN_2
# MAGIC union all
