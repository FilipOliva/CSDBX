...
# MAGIC %md
# MAGIC ## Mapping steps ADS_SMA_CASE_PHASE_PROPERTIES_MAIN_5
...
map_id = 'ADS_SMA_CASE_PHASE_PROPERTIES_MAIN_5'
schema_name = 'gap_catalog.ads_owner'
dif_table = 'gap_catalog.ads_owner.DIFF_ADS_SMA_CASE_PHASE_PROPERTIES_MAIN_5_ADS_MAP_SCD_DIFF'
...
# MAGIC %sql truncate table gap_catalog.ads_etl_owner.XC_SMA_CASE_PHASE_PROPERTIES_MAIN_5

# COMMAND ----------

# DBTITLE 1,Fill XC Table
# MAGIC %sql
# MAGIC INSERT INTO gap_catalog.ads_etl_owner.XC_SMA_CASE_PHASE_PROPERTIES_MAIN_5 
...
# MAGIC %sql
# MAGIC DROP TABLE IF EXISTS gap_catalog.ads_owner.DIFF_ADS_SMA_CASE_PHASE_PROPERTIES_MAIN_5_ADS_MAP_SCD_DIFF;

# COMMAND ----------

# DBTITLE 1,Create DIFF Table
# MAGIC %sql
# MAGIC create  table gap_catalog.ads_owner.DIFF_ADS_SMA_CASE_PHASE_PROPERTIES_MAIN_5_ADS_MAP_SCD_DIFF
...
# MAGIC        CPPROP_VALUE_NUMBER, 
# MAGIC        CPPRV_KEY
# MAGIC        from gap_catalog.ads_etl_owner.XC_SMA_CASE_PHASE_PROPERTIES_MAIN_5 xc
# MAGIC     where (CPPROP_SOURCE_SYSTEM_ID = 'SMA'
# MAGIC             AND CPPROP_SOURCE_SYS_ORIGIN = 'SMA_MONITOR_EVENTS'
# MAGIC             AND CTP_KEY IN ( 51075,22705,7315,63075,65175,155,175,245,265,285,1465,3705,57775,4905,1475,9575,13585,47975,58775,565,5,25,73575,76075,30215,50875,15815,20685,1295,1305,185,1425,735,65,485,225,45,1505,1525,895,1455,1485,53275,1245,1025,1045,1055,1065,76785,745,765,9485,2395,2805,2505,3605,2045,1445,7305,2355,1195,2365,2375,3405,17135,56975,70175,77725,84805,81725,49075,79325,84265,87465,87455,88255,76475,72675,85715,1135,80425,87635,82755,85935,85985,90185,89355,90635,92055,90475,80465,84135 ))) src LEFT JOIN
...
# MAGIC             AND CPPROP_SOURCE_SYS_ORIGIN = 'SMA_MONITOR_EVENTS'
# MAGIC             AND CTP_KEY IN ( 51075,22705,7315,63075,65175,155,175,245,265,285,1465,3705,57775,4905,1475,9575,13585,47975,58775,565,5,25,73575,76075,30215,50875,15815,20685,1295,1305,185,1425,735,65,485,225,45,1505,1525,895,1455,1485,53275,1245,1025,1045,1055,1065,76785,745,765,9485,2395,2805,2505,3605,2045,1445,7305,2355,1195,2365,2375,3405,17135,56975,70175,77725,84805,81725,49075,79325,84265,87465,87455,88255,76475,72675,85715,1135,80425,87635,82755,85935,85985,90185,89355,90635,92055,90475,80465,84135 ))      ) trg
...
# MAGIC union all
# MAGIC select '2-XC_SMA_CASE_PHASE_PROPERTIES_MAIN_5', count(1) from gap_catalog.ads_etl_owner.XC_SMA_CASE_PHASE_PROPERTIES_MAIN_5
# MAGIC union all
