...
# MAGIC %sql
# MAGIC DROP TABLE IF EXISTS gap_catalog.ads_owner.DIFF_ADS_STG_SMA_CASE_PHASE_PROPERTIES_UPDATE;

# COMMAND ----------

# DBTITLE 1,Create DIFF Table
# MAGIC %sql
# MAGIC CREATE TABLE gap_catalog.ads_owner.DIFF_ADS_STG_SMA_CASE_PHASE_PROPERTIES_UPDATE (
