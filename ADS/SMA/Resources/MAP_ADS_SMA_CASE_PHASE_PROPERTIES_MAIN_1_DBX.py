...
# MAGIC %md
# MAGIC ## Mapping steps ADS_SMA_CASE_PHASE_PROPERTIES_MAIN_1
...
map_id = 'ADS_SMA_CASE_PHASE_PROPERTIES_MAIN_1'
schema_name = 'gap_catalog.ads_owner'
dif_table = 'gap_catalog.ads_owner.DIFF_ADS_SMA_CASE_PHASE_PROPERTIES_MAIN_1_ADS_MAP_SCD_DIFF'
...
# MAGIC %sql truncate table gap_catalog.ads_etl_owner.XC_SMA_CASE_PHASE_PROPERTIES_MAIN_1

# COMMAND ----------

# DBTITLE 1,Fill XC Table
# MAGIC %sql
# MAGIC INSERT INTO gap_catalog.ads_etl_owner.XC_SMA_CASE_PHASE_PROPERTIES_MAIN_1 
...
# MAGIC %sql
# MAGIC DROP TABLE IF EXISTS gap_catalog.ads_owner.DIFF_ADS_SMA_CASE_PHASE_PROPERTIES_MAIN_1_ADS_MAP_SCD_DIFF;

# COMMAND ----------

# DBTITLE 1,Create DIFF Table
# MAGIC %sql
# MAGIC create  table gap_catalog.ads_owner.DIFF_ADS_SMA_CASE_PHASE_PROPERTIES_MAIN_1_ADS_MAP_SCD_DIFF
...
# MAGIC        CPPROP_VALUE_NUMBER, 
# MAGIC        CPPRV_KEY
# MAGIC        from gap_catalog.ads_etl_owner.XC_SMA_CASE_PHASE_PROPERTIES_MAIN_1 xc
# MAGIC     where (CPPROP_SOURCE_SYSTEM_ID = 'SMA'
# MAGIC             AND CPPROP_SOURCE_SYS_ORIGIN = 'SMA_MONITOR_EVENTS'
# MAGIC             AND CTP_KEY IN ( 19581,50991,6531,7311,1091,48911,48501,101,191,241,6721,15121,2041,52381,491,571,12711,7321,20681,30181,1271,1291,1431,1461,561,611,621,91,51,1471,1501,1531,1481,15851,1081,871,941,9451,9481,1421,13581,1441,861,9751,6581,12761,20611,83341,79521,84731,87461,79821,86691,87731,79171,77721,85351,86011,89151,90181,85641,92991,92591,92781,78721,92101,83411,90981,91681,91481,90841,31,83321,89771,93081 ))) src LEFT JOIN
...
# MAGIC             AND CPPROP_SOURCE_SYS_ORIGIN = 'SMA_MONITOR_EVENTS'
# MAGIC             AND CTP_KEY IN ( 19581,50991,6531,7311,1091,48911,48501,101,191,241,6721,15121,2041,52381,491,571,12711,7321,20681,30181,1271,1291,1431,1461,561,611,621,91,51,1471,1501,1531,1481,15851,1081,871,941,9451,9481,1421,13581,1441,861,9751,6581,12761,20611,83341,79521,84731,87461,79821,86691,87731,79171,77721,85351,86011,89151,90181,85641,92991,92591,92781,78721,92101,83411,90981,91681,91481,90841,31,83321,89771,93081 ))      ) trg
...
# MAGIC union all
# MAGIC select '2-XC_SMA_CASE_PHASE_PROPERTIES_MAIN_1', count(1) from gap_catalog.ads_etl_owner.XC_SMA_CASE_PHASE_PROPERTIES_MAIN_1
# MAGIC union all
