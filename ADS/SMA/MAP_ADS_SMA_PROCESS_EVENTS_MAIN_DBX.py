...
# MAGIC %sql
# MAGIC DROP TABLE IF EXISTS gap_catalog.ads_owner.DIFF_ADS_SMA_PROCESS_EVENTS_MAIN;

# COMMAND ----------

# DBTITLE 1,Create DIFF Table
# MAGIC %sql
# MAGIC CREATE TABLE gap_catalog.ads_owner.DIFF_ADS_SMA_PROCESS_EVENTS_MAIN (
