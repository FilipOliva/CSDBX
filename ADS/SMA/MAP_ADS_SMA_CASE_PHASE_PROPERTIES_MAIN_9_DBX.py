...
# MAGIC %md
# MAGIC ## Mapping steps ADS_SMA_CASE_PHASE_PROPERTIES_MAIN_9
...
map_id = 'ADS_SMA_CASE_PHASE_PROPERTIES_MAIN_9'
schema_name = 'gap_catalog.ads_owner'
dif_table = 'gap_catalog.ads_owner.DIFF_ADS_SMA_CASE_PHASE_PROPERTIES_MAIN_9_ADS_MAP_SCD_DIFF'
...
# MAGIC %sql truncate table gap_catalog.ads_etl_owner.XC_SMA_CASE_PHASE_PROPERTIES_MAIN_9

# COMMAND ----------

# DBTITLE 1,Fill XC Table
# MAGIC %sql
# MAGIC INSERT INTO gap_catalog.ads_etl_owner.XC_SMA_CASE_PHASE_PROPERTIES_MAIN_9 
...
# MAGIC             and mod(ctp_key,10) = 9
# MAGIC             and CTP_SOURCE_ID != 'SCESIG'
# MAGIC       )
# MAGIC       SELECT
...
# MAGIC %sql
# MAGIC DROP TABLE IF EXISTS gap_catalog.ads_owner.DIFF_ADS_SMA_CASE_PHASE_PROPERTIES_MAIN_9_ADS_MAP_SCD_DIFF;

# COMMAND ----------

# DBTITLE 1,Create DIFF Table
# MAGIC %sql
# MAGIC create  table gap_catalog.ads_owner.DIFF_ADS_SMA_CASE_PHASE_PROPERTIES_MAIN_9_ADS_MAP_SCD_DIFF
...
# MAGIC        CPPROP_VALUE_NUMBER, 
# MAGIC        CPPRV_KEY
# MAGIC        from gap_catalog.ads_etl_owner.XC_SMA_CASE_PHASE_PROPERTIES_MAIN_9 xc
# MAGIC     where (CPPROP_SOURCE_SYSTEM_ID = 'SMA'
# MAGIC             AND CPPROP_SOURCE_SYS_ORIGIN = 'SMA_MONITOR_EVENTS'
# MAGIC             AND CTP_KEY IN ( 51679,7319,58179,65179,179,209,6719,1479,1469,549,49,12789,12709,3609,9549,64289,50879,13649,16219,1289,1309,1419,569,859,1499,1449,62779,15849,1119,1129,76709,839,869,949,9449,9479,2399,9,13589,1459,1489,7309,2369,619,76079,77819,80119,82819,81869,77719,82029,80729,81319,82719,87259,82519,84919,88869,80419,84619,84019,89199,86819,87119,90189,92999,90399,91099,87249,90699,79119,88829,89209,91319,89849,83319 ))) src LEFT JOIN
...
# MAGIC union all
# MAGIC select '2-XC_SMA_CASE_PHASE_PROPERTIES_MAIN_9', count(1) from gap_catalog.ads_etl_owner.XC_SMA_CASE_PHASE_PROPERTIES_MAIN_9
# MAGIC union all
