...
# MAGIC %md
# MAGIC ## Mapping steps ADS_SMA_CASE_PHASE_PROPERTIES_MAIN_7
...
map_id = 'ADS_SMA_CASE_PHASE_PROPERTIES_MAIN_7'
schema_name = 'gap_catalog.ads_owner'
dif_table = 'gap_catalog.ads_owner.DIFF_ADS_SMA_CASE_PHASE_PROPERTIES_MAIN_7_ADS_MAP_SCD_DIFF'
...
# MAGIC %sql truncate table gap_catalog.ads_etl_owner.XC_SMA_CASE_PHASE_PROPERTIES_MAIN_7

# COMMAND ----------

# DBTITLE 1,Fill XC Table
# MAGIC %sql
# MAGIC INSERT INTO gap_catalog.ads_etl_owner.XC_SMA_CASE_PHASE_PROPERTIES_MAIN_7 
...
# MAGIC %sql
# MAGIC DROP TABLE IF EXISTS gap_catalog.ads_owner.DIFF_ADS_SMA_CASE_PHASE_PROPERTIES_MAIN_7_ADS_MAP_SCD_DIFF;

# COMMAND ----------

# DBTITLE 1,Create DIFF Table
# MAGIC %sql
# MAGIC create  table gap_catalog.ads_owner.DIFF_ADS_SMA_CASE_PHASE_PROPERTIES_MAIN_7_ADS_MAP_SCD_DIFF
...
# MAGIC        CPPROP_VALUE_NUMBER, 
# MAGIC        CPPRV_KEY
# MAGIC        from gap_catalog.ads_etl_owner.XC_SMA_CASE_PHASE_PROPERTIES_MAIN_7 xc
# MAGIC     where (CPPROP_SOURCE_SYSTEM_ID = 'SMA'
# MAGIC             AND CPPROP_SOURCE_SYS_ORIGIN = 'SMA_MONITOR_EVENTS'
# MAGIC             AND CTP_KEY IN ( 51677,7317,65177,9937,60977,62677,3807,1477,1467,3607,13587,567,7,27,9547,76587,50877,7307,61707,13647,20347,1247,1257,737,187,197,1287,1307,537,1447,1497,15847,16887,1067,1117,63877,17147,2507,1527,17007,2037,1457,2047,48457,2377,3407,6577,617,16207,6737,79257,76077,82747,82737,89747,89197,72677,87817,84937,83447,85717,84467,91227,90187,88617,87467,89867,82757,90327 ))) src LEFT JOIN
...
# MAGIC             AND CPPROP_SOURCE_SYS_ORIGIN = 'SMA_MONITOR_EVENTS'
# MAGIC             AND CTP_KEY IN ( 51677,7317,65177,9937,60977,62677,3807,1477,1467,3607,13587,567,7,27,9547,76587,50877,7307,61707,13647,20347,1247,1257,737,187,197,1287,1307,537,1447,1497,15847,16887,1067,1117,63877,17147,2507,1527,17007,2037,1457,2047,48457,2377,3407,6577,617,16207,6737,79257,76077,82747,82737,89747,89197,72677,87817,84937,83447,85717,84467,91227,90187,88617,87467,89867,82757,90327 ))      ) trg
...
# MAGIC union all
# MAGIC select '2-XC_SMA_CASE_PHASE_PROPERTIES_MAIN_7', count(1) from gap_catalog.ads_etl_owner.XC_SMA_CASE_PHASE_PROPERTIES_MAIN_7
# MAGIC union all
